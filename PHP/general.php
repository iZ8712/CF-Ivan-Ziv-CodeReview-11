...
$sql ="SELECT * FROM animals WHERE (SIZE='small') UNION SELECT * FROM animals WHERE (SIZE='large')";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
      <a class="nav-link m-2" href="general.php">Small and Large Pets</a>
      </li>
      <li class="nav-item">
      <a class="nav-link m-2" href="senior.php">Seniro Pets</a>
      </li>
      <li class="nav-item">
